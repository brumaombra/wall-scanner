...
  // per fare la media
    ...
    float soglia = 0.5;
  // soglia per sensibilit? per i LED
...
float Xcm = 0, Ycm = 0;
byte NCM = 5;
  // numero di cm ogni quanto fare una misura
bool first = true;
  // per capire se ? la prima iterazione
bool firstPython = true;
bool OKXY = true;
  // variabile per capire se ho già misurato in un certo pixel
       
